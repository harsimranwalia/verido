          ...
          <div>
            ...
            <div className="hidden md:block">
              ...
              <p className="mb-5 max-w-xs text-[0.95rem] leading-relaxed text-slate-600">
                Connect with our experts to explore how Verido can seamlessly integrate and elevate your product experience.
              </p>
              ...
              <div className="space-y-5">
                {[
                  { label: "Email", value: "hello@verido.co", href: "mailto:hello@verido.co" },
                  { label: "Phone", value: "+1 647 794 8516  ·  +971 50 357 2760", href: "tel:+16477948516" },
            ...
            <div className="md:hidden mb-6">
              ...
              <div className="flex flex-col gap-3">
                {[
                  {
                    label: "Email", value: "hello@verido.co", href: "mailto:hello@verido.co", icon: (
                  ...
                  {
                    label: "Phone", value: "+1 647 794 8516  ·  +971 50 357 2760", href: "tel:+16477948516", icon: (
